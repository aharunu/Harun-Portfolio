...
const BlogPage = () => {
    return (
        <div className="h-1/2 flex-col font-bold justify-center text-white text-center ">
            <h1 className="text-3xl pl-8 pb-8">Next.js ile Portföy Oluşturma</h1>
            <h2 className="text-black text-2xl">Neden Portfolyo Oluşturmalıyım</h2>
            <h3 className="pl-10 font-light">
            ...
            <h2 className="text-black text-2xl pt-3">Neden Nextjs</h2>
            ...
            <h2 className="text-black text-2xl pt-3">Başlangıç</h2>
            ...
            <h2 className="text-black text-2xl pt-3">Components</h2>
            ...
            <h2 className="text-black text-2xl pt-3">Sayfalar</h2>
            <p>Ana Sayfa</p>
            ...
            <h2 className="text-black text-xl pt-3">Yayınlama</h2>
